  ...
  return (
    <div>
      ...
      {anecdote ? (
        <div>
          <p>
            <strong>Content:</strong> {anecdote.content}
          </p>
          <p>
...
const CreateNew = (props) => {
  ...
  const contentInputProps = { ...contentField };
  delete contentInputProps.reset;

  const authorInputProps = { ...authorField };
  delete authorInputProps.reset;

  const infoInputProps = { ...infoField };
  delete infoInputProps.reset;
  ...
  const handleSubmit = (e) => {
    ...
    props.setNotification(`creaste la anecdote "${contentField.value}"`);
    navigate("/");
    setTimeout(() => {
